    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        locationListener = new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                ...
                //mMap.clear();
                mMap.addMarker(new MarkerOptions().position(yourLocation).title("MyLocation").snippet("").icon(BitmapDescriptorFactory.fromResource(R.mipmap.ic_launcher_map_man)));
