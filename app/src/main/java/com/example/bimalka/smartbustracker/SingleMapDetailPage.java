...
public class SingleMapDetailPage extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(haldum).title("ToColombo").snippet("Location : Haputale").icon(BitmapDescriptorFactory.fromResource(R.mipmap.ic_launcher_bus_icon)));
